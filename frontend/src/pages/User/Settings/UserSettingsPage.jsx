        ...
        >
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" color="text.secondary">
              Manage your personal preferences, notifications, and account security
            </Typography>
          </Box>
                ...
                <Card sx={{ mt: 3 }}>
                  <CardContent>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                      <Avatar
                        src={`https://ui-avatars.com/api/?name=${encodeURIComponent(user.name)}&background=4CAF50&color=fff&size=80`}
                    ...
                    <Grid container spacing={1}>
                      ...
                      <Grid item xs={6}>
                        ...
                        <Typography variant="subtitle2" fontWeight={600}>
                          {citizenStats.participationScore}
                        </Typography>
                      </Grid>
                    </Grid>
                  </CardContent>
                ...
                {activeTab === 0 && (
                  <Box sx={{ flex: 1 }}>
                    ...
                    <Typography variant="body2" color="text.secondary" paragraph>
                      Configure how you receive updates about your reports and the platform.
                    </Typography>
                    ...
                    <List>
                      ...
                      <ListItem>
                        ...
                        <ListItemText 
                          ...
                          secondary="Get notified when your submitted reports are updated"
                        />
                        <ListItemSecondaryAction>
                          <Switch
                            edge="end"
                      ...
                      <ListItem>
                        ...
                        <ListItemText 
                          primary="Feedback Notifications" 
                          secondary="When officials or staff comment on your reports"
                        />
                        <ListItemSecondaryAction>
                          <Switch
                            edge="end"
                      ...
                      <ListItem>
                        ...
                        <ListItemText 
                          primary="Updates Near You" 
                          secondary="Alerts about new issues reported near your location"
                        />
                        <ListItemSecondaryAction>
                          <Switch
                            edge="end"
                            checked={notificationSettings.newUpdatesNearby}
                            onChange={handleNotificationChange('newUpdatesNearby')}
                          />
                        </ListItemSecondaryAction>
                      </ListItem>
                      ...
                      <ListItem>
                        <ListItemText 
                          ...
                          secondary="Summary of your contributions and activity"
                        />
                        <ListItemSecondaryAction>
                          <Switch
                            edge="end"
          ...
          <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)}>
            ...
            <DialogContent>
              ...
              <List dense>
                <ListItem>
                  <ListItemText primary="• Remove all your submitted reports from the system" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="• Delete your account history and profile" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="• Remove your contributions and feedback" />
                </ListItem>
                <ListItem>
                  <ListItemText primary="• Cancel any ongoing engagement" />
                </ListItem>
              </List>
